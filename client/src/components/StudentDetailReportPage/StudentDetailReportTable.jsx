...
function StudentDetailReportTable({subjectsAndTeachers}) {
    const data = useMemo(() => subjectsAndTeachers , [subjectsAndTeachers]);
...
export default StudentDetailReportTable;