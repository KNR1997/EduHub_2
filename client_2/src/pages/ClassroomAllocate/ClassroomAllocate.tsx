        ...
        <div className="info">
          ...
          <div className="topInfo">
            ...
            <div className="dropdown">
              ...
              >
                {classrooms?.map((option: SubjectInterface) => (
            ...
            <Button variant="contained" onClick={AllocateClassroom}>Allocate</Button>
          </div>
...
export default ClassroomAllocate;
